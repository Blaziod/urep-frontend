...
export default function Home() {
  return (
      <div className={'pt-1'}>
        <div className={'pt-1 px-4 sm:px-8 md:px-16 lg:px-32'}>
          <div className={'mx-auto flex flex-col sm:flex-row items-center px-1 py-2 bg-[#277B12] mb-4'}>
            ...
            <div className={'grow my-4 sm:my-0'}>
          ...
          <div className={'flex flex-col items-center w-full'}>
            <div className={'flex flex-col md:flex-row justify-center items-center gap-6 md:gap-x-8 lg:gap-x-16 mt-6 md:mt-10'}>
              <Image src={'/images/man1.png'} alt={'man'} width={250} height={250} className="hidden md:block" />
              ...
              <Image src={'/images/man2.png'} alt={'man'} width={250} height={250} className="hidden md:block" />
            </div>
            <div className={'flex flex-row space-x-4 mt-6 md:mt-10 justify-between w-full max-w-xs md:max-w-md'}>
          ...
          <div className={'flex flex-col justify-center w-full bg-gradient-to-b from-[#277B12] to-[#F9E79F] mt-6 md:mt-10 py-6 px-4'}>
            ...
            <div className={'flex flex-col lg:flex-row items-center gap-6 lg:gap-x-10 xl:gap-x-20'}>
              <div className={'flex-col justify-start w-full lg:w-1/2'}>
                ...
                <ul className="pl-4">
                  <li className={'text-gray-500 font-normal text-base md:text-lg text-wrap leading-6 md:leading-8'}>To provide youth with modern baking and confectionery skills to enable them become self-reliant and employers of labour.</li>
                  <li className={'text-gray-500 font-normal text-base md:text-lg text-wrap leading-6 md:leading-8'}>To empower youth to establish small and medium scale enterprises in the baking and confectionery industry.</li>
                  <li className={'text-gray-500 font-normal text-base md:text-lg text-wrap leading-6 md:leading-8'}>To reduce youth unemployment and restiveness in the country.</li>
                  <li className={'text-gray-500 font-normal text-base md:text-lg text-wrap leading-6 md:leading-8'}>To promote the culture of entrepreneurship among the youth.</li>
                </ul>
                <h3 className={'justify-self-end text-lg md:text-xl text-white font-semibold'}>Learn More</h3>
                <hr className="my-3"/>
              </div>
              <div className={'flex flex-col justify-center items-center w-full lg:w-1/2'}>
                ...
                <h3 className={'text-center text-xl md:text-2xl text-[#277B12] font-semibold mt-3'}>Register Now</h3>
              </div>
            </div>
          </div>
